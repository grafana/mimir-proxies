...
func (ma *MeasuredAPI) Query(ctx context.Context, query string, ts time.Time) (v model.Value, w v1.Warnings, err error) {
	...
	return ma.api.Query(ctx, query, ts)
}

func (ma *MeasuredAPI) QueryRange(ctx context.Context, query string, r v1.Range) (v model.Value, w v1.Warnings, err error) {
	...
	return ma.api.QueryRange(ctx, query, r)
}
